...
*/
SecondSceneSoundManager::SecondSceneSoundManager(BaseScene* _owner)
	: GameObject(false, Tag::AUDIO)
{
	...
	// BGMを生成
	bgm = new MusicComponent(this, "Assets/Sound/Bgm/Game/Second.wav");
...
@brief  objectの削除を行う
*/
SecondSceneSoundManager::~SecondSceneSoundManager()
{
}
...
*/
void SecondSceneSoundManager::UpdateGameObject(float _deltaTime)
{
	// カウントダウン音を再生する状態だったら
