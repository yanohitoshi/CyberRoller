...
/*
@file ThirdSceneSoundManager.h
@brief 第三ステージシーンのサウンドを管理するクラス
*/
class ThirdSceneSoundManager :
    public GameObject
{
public:
	...
	*/
	ThirdSceneSoundManager(BaseScene* _owner);

	/*
	@fn デストラクタ
	@brief  objectの削除を行う
	*/
	~ThirdSceneSoundManager()override;
