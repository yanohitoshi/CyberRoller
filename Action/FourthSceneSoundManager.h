...
/*
@file FourthSceneSoundManager.h
@brief 第四ステージシーンのサウンドを管理するクラス
*/
class FourthSceneSoundManager :
    public GameObject
{
public:
	...
	*/
	FourthSceneSoundManager(BaseScene* _owner);

	/*
	@fn デストラクタ
	@brief  objectの削除を行う
	*/
	~FourthSceneSoundManager()override;
