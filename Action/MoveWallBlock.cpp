	...
	, ShiftPositionY(200.0f)
{
	...
	geometryInstanceComponent = new GeometryInstanceComponent(this, GRAPHICS_RESOURCE->CreateMesh("Assets/Model/Environment/MoveWall/model/moveWallBox.gpmesh"), GeometryInstanceType::G_MOVE_WALL);
