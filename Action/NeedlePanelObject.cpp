	...
	GameObject(false, _objectTag)
{
	...
	geometryInstanceComponent = new GeometryInstanceComponent(this, GRAPHICS_RESOURCE->CreateMesh("Assets/Model/Environment/Ground/model/lightGround.gpmesh"), GeometryInstanceType::G_NEEDLE_PANEL);
