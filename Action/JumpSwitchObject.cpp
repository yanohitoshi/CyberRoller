	...
	: GameObject(false, _objectTag)
{
	...
	geometryInstanceComponent = new GeometryInstanceComponent(this, RENDERING_OBJECT_MANAGER->GetMesh("Assets/Model/Environment/JumpSwitch/model/jumpSwitch.gpmesh"), GeometryInstanceType::G_JUMP_SWITCH);
