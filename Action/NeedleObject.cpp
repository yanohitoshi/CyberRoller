	...
	GameObject(false, _objectTag)
{
	...
	geometryInstanceComponent = new GeometryInstanceComponent(this, RENDERER->GetMesh("Assets/Model/Environment/goods_model/needles.gpmesh"), GeometryInstanceType::G_NEEDLE,300);
