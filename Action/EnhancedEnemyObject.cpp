	...
	, Angle(180.0f)
{
	...
	// 怯み時のアニメーション
	animTypes[static_cast<unsigned int>(EnemyState::ENEMY_STATE_FLINCH)] = RENDERING_OBJECT_MANAGER->GetAnimation("Assets/Model/Enemy/animation/Dron_01_Get_Hit.gpanim", false);
	// ターンアニメーション
