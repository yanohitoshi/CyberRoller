...
FourthStageUI::FourthStageUI(PlayerObject* _playerObject, CollectionObject* _first, CollectionObject* _second, CollectionObject* _third)
...
FourthStageUI::~FourthStageUI()
{
}

void FourthStageUI::UpdateGameObject(float _deltaTime)
{
