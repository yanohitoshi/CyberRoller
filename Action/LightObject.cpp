	...
	, ShiftPositionZ(110.0f)
{
	...
	geometryInstanceComponent = new GeometryInstanceComponent(this, GRAPHICS_RESOURCE->CreateMesh("Assets/Model/Environment/Light/model/SM_PowerCells_Floor.gpmesh"), GeometryInstanceType::G_LIGHT,300);
