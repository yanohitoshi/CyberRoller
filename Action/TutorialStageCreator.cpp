...
*/
TutorialStageCreator::TutorialStageCreator(bool _reUseGameObject, const Tag _objectTag)
...
@brief マップデータの削除を行う
*/
TutorialStageCreator::~TutorialStageCreator()
{
	//マップデータの後始末
...
@return 成功か否か
*/
bool TutorialStageCreator::OpenFile()
{

	// ステージデータ読み込み (baseLayer)
	if (!readTiledJson(layer1StageData, "Assets/Config/StageData/TutorialStageMap.json", "layer1"))
	{
	...
	// ステージデータ読み込み (layer2) 
	if (!readTiledJson(layer2StageData, "Assets/Config/StageData/TutorialStageMap.json", "layer2"))
	{
	...
	// ステージデータ読み込み (layer3) 
	if (!readTiledJson(layer3StageData, "Assets/Config/StageData/TutorialStageMap.json", "layer3"))
	{
	...
	// ステージデータ読み込み (layer4) 
	if (!readTiledJson(layer4StageData, "Assets/Config/StageData/TutorialStageMap.json", "layer4"))
	{
	...
	// ステージデータ読み込み (layer5) 
	if (!readTiledJson(layer5StageData, "Assets/Config/StageData/TutorialStageMap.json", "layer5"))
	{
	...
	// ステージデータ読み込み (player) 
	if (!readTiledJson(playerData, "Assets/Config/StageData/TutorialStageMap.json", "Player"))
	{
	...
	if (!readTiledJson(cameraDirectingData, "Assets/Config/StageData/TutorialStageMap.json", "CameraDirecting"))
	{
...
@fn ステージを生成する
*/
void TutorialStageCreator::CreateStage()
{
...
void TutorialStageCreator::CreateCamera()
{
}
...
*/
void TutorialStageCreator::CreateLayer1(int _indexX, int _indexY)
{
...
@param	_indexY 検索するマップデータの添え字Y
*/
void TutorialStageCreator::CreateLayer2(int _indexX, int _indexY)
{
	// ステージデータ配列からマップデータをもらう
...
@param	_indexY 検索するマップデータの添え字Y
*/
void TutorialStageCreator::CreateLayer3(int _indexX, int _indexY)
{
	// ステージデータ配列からマップデータをもらう
...
@param	_indexY 検索するマップデータの添え字Y
*/
void TutorialStageCreator::CreateLayer4(int _indexX, int _indexY)
{
	// ステージデータ配列からマップデータをもらう
...
@param	_indexY 検索するマップデータの添え字Y
*/
void TutorialStageCreator::CreateLayer5(int _indexX, int _indexY)
{
	// ステージデータ配列からマップデータをもらう
