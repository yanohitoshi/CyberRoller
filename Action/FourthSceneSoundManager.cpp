...
*/
FourthSceneSoundManager::FourthSceneSoundManager(BaseScene* _owner)
	: GameObject(false, Tag::AUDIO)
{
	...
	// BGMを生成
	bgm = new MusicComponent(this, "Assets/Sound/Bgm/Game/Fourth.wav");
...
@brief  objectの削除を行う
*/
FourthSceneSoundManager::~FourthSceneSoundManager()
{
}
...
*/
void FourthSceneSoundManager::UpdateGameObject(float _deltaTime)
{
	// カウントダウン音を再生する状態だったら
